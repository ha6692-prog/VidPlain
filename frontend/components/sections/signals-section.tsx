...
const signals = [
  {
    ...
    note: "AI analyzes pacing and comprehension to dynamically generate your curriculum.",
  },
  {
    date: "2026.02.28",
    title: "Weak-Topic Heatmaps",
    note: "Visual analytics pinpoint exactly where your knowledge gaps are.",
  },
  {
    date: "2026.02.15",
    title: "Interactive AI Chat",
    note: "Step-by-step explanations, Socratic questioning, and immediate feedback 24/7.",
  },
  {
    date: "2026.01.30",
    title: "Well-being Companion",
    note: "Built-in mood tracking, stress check-ins, and study-break timers.",
  },
  {
    date: "2026.01.12",
    title: "Smart Recommender",
    note: "Always know exactly what topic to jump into next based on past quizzes.",
  },
]
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">WHY VIDPLAIN</h2>
      </div>
