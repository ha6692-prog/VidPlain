  ...
  const principles = [
    {
      number: "01",
      titleParts: [
        { text: "ADAPTIVE", highlight: true },
        { text: " LEARNING", highlight: false },
      ],
      description: "Our AI dynamically generates a curriculum that evolves with your skills — always challenged, never overwhelmed.",
      align: "left",
    },
    {
      number: "02",
      ...
      description: "Visual heatmaps pinpoint exactly where your knowledge gaps are. Let data guide your focus.",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        { text: "JUDGEMENT-FREE ", highlight: false },
        { text: "ZONE", highlight: true },
      ],
      description: "Ask any question. Our AI tutor is infinitely patient and explains concepts in multiple different ways.",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        { text: "WELL-BEING ", highlight: false },
        { text: "FIRST", highlight: true },
      ],
      description: "Built-in mood tracking, stress check-ins, and study-break timers. Your mental health is a priority.",
      align: "right",
    },
  ]
